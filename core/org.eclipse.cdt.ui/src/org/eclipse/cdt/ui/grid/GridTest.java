...
public class GridTest {
	...
	private void buildUI(final Display display, final Shell shell) {
		...
		*/
		...
		pillElement.fillIntoGrid(shell);
		...
		pillElement2.fillIntoGrid(shell);		
		...
		*/
		...
		executableLinks.fillIntoGrid(shell);
	...
	//	kernel.fillIntoGrid(shell);
		...
		kernelLinks.fillIntoGrid(shell);

		
		H2Element bs2 = new H2Element("Build System");
		bs2.fillIntoGrid(shell);
